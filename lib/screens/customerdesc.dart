    ...
    return Consumer(builder: (context, ref, child) {
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          title: Text(" Customer Detail Description"),
        ),
        body: Container(
                          ...
                          return Card(
                            child: ListTile(
                              leading: CircleAvatar(
                                  backgroundImage: NetworkImage(dat.userImage)),
                              ...
                              children: [
                                ...
                                StreamBuilder<QuerySnapshot>(
                                  stream: FirebaseFirestore.instance
                                      .collection("customersdesigndescription")
                                    ...
                                    return DropdownButton(
                                      ...
                                      items: snapshot.data?.docs.map((value) {
                                        return DropdownMenuItem(
                                          value: value.get('designDescription'),
                                          child: Text(
                                              '${value.get('designDescription')}'),
                                        );
                                      }).toList(),
                                      onChanged: (value) {
                                ...
                                StreamBuilder<QuerySnapshot>(
                                  ...
                                  builder: (BuildContext context,
                                    ...
                                    return DropdownButton(
                                      isExpanded: false,
                                      value: designer,
                                      items: snapshots.data?.docs.map((value) {
                                        return DropdownMenuItem(
